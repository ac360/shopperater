		  	...
		  	if (pw < 420) {	
					...
					// Set Event Listener for Clicking A Medley Item
		  			$('.MDLYa1').on('click', '.MDLYa1-item', function (e) {
							...
							var infoCategory = '<p style="text-align:left !important;font-size:12px !important;font-family: sans-serif !important;color:#555 !important;">Category: ' + itemObject.category + '</p>'
							var infoPrice = '<p style="text-align:left !important;font-size:12px !important;font-family: sans-serif !important;color:#555 !important;">Best Price: $' + itemObject.price + '</p>'
							var infoSource   = '<p style="text-align:left !important;font-size:12px !important;font-family: sans-serif !important;color:#555 !important;text-transform:capitalize !important;">Best Price Found On: ' + itemObject.source + '</p>'
