		  	...
		  	if (pw < 420) {	
					...
					// Set Event Listener for Clicking A Medley Item
		  			$('.MDLYa1').on('click', '.MDLYa1-item', function (e) {
							...
							var infoTitle = '<h2 style="text-align:left !important;font-size:14px !important;line-height: 20px !important;margin-bottom:4px !important;font-family: nexa_boldregular, sans-serif !important;text-transform:uppercase !important;color:#333 !important;">' + itemObject.title + '</h2>'
