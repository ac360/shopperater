...
ActiveRecord::Schema.define(:version => 20130814204721) do
  ...
  create_table "medleys", :force => true do |t|
    ...
    t.datetime "created_at",                   :null => false
    t.datetime "updated_at",                   :null => false
    t.integer  "item_one_size_x"
    t.integer  "item_one_size_y"
    t.integer  "item_one_column"
    t.integer  "item_one_row"
    t.integer  "item_two_size_x"
    t.integer  "item_two_size_y"
    t.integer  "item_two_column"
    t.integer  "item_two_row"
    t.integer  "item_three_size_x"
    t.integer  "item_three_size_y"
    t.integer  "item_three_column"
    t.integer  "item_three_row"
    t.integer  "item_four_size_x"
    t.integer  "item_four_size_y"
    t.integer  "item_four_column"
    t.integer  "item_four_row"
    t.integer  "item_five_size_x"
    t.integer  "item_five_size_y"
    t.integer  "item_five_column"
    t.integer  "item_five_row"
    t.integer  "item_six_size_x"
    t.integer  "item_six_size_y"
    t.integer  "item_six_column"
    t.integer  "item_six_row"
    t.integer  "item_seven_size_x"
    t.integer  "item_seven_size_y"
    t.integer  "item_seven_column"
    t.integer  "item_seven_row"
    t.integer  "item_eight_size_x"
    t.integer  "item_eight_size_y"
    t.integer  "item_eight_column"
    t.integer  "item_eight_row"
    t.integer  "item_nine_size_x"
    t.integer  "item_nine_size_y"
    t.integer  "item_nine_column"
    t.integer  "item_nine_row"
    t.integer  "item_ten_size_x"
    t.integer  "item_ten_size_y"
    t.integer  "item_ten_column"
    t.integer  "item_ten_row"
    t.integer  "item_eleven_size_x"
    t.integer  "item_eleven_size_y"
    t.integer  "item_eleven_column"
    t.integer  "item_eleven_row"
    t.integer  "item_twelve_size_x"
    t.integer  "item_twelve_size_y"
    t.integer  "item_twelve_column"
    t.integer  "item_twelve_row"
    t.integer  "item_thirteen_size_x"
    t.integer  "item_thirteen_size_y"
    t.integer  "item_thirteen_column"
    t.integer  "item_thirteen_row"
    t.integer  "item_fourteen_size_x"
    t.integer  "item_fourteen_size_y"
    t.integer  "item_fourteen_column"
    t.integer  "item_fourteen_row"
    t.integer  "item_fifteen_size_x"
    t.integer  "item_fifteen_size_y"
    t.integer  "item_fifteen_column"
    t.integer  "item_fifteen_row"
    t.integer  "item_sixteen_size_x"
    t.integer  "item_sixteen_size_y"
    t.integer  "item_sixteen_column"
    t.integer  "item_sixteen_row"
  end
